  ...
  singletons: {
    home: singleton({
      ...
      schema: {
        ...
        releaseYoutubeUrl: fields.text({ label: 'YouTube Video URL (Latest Release)' }),
        releaseSpotifyUrl: fields.text({ label: 'Spotify Track URL (Latest Release)' }),
        releaseAppleMusicUrl: fields.text({ label: 'Apple Music URL (Latest Release)' }),
